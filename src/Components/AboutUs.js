...
function AboutUs() {
  ...
  return (
    <div className={`min-h-screen h-auto  px-5 md:px-12 lg:px-[70px] xl:px-[110px] w-full  bg-no-repeat bg-cover bg-center bg-[url('../public/images/aboutusbg.png')] `}>
      ...
      <div className={`px-5 md:px-12 py-12 flex flex-col md:flex-row gap-9 items-center w-full mt-14 pb-10 bg-no-repeat bg-cover bg-center rounded-2xl  bg-[url('../public/images/aboutusmidbg.png')] `}>
