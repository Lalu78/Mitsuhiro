...
function HowToOperate() {
    return (
        <div className={`h-auto min-h-[510px]  xl:gap-60 px-6 md:px-12  xl:px-[90px] w-full flex flex-col lg:flex-row bg-no-repeat bg-cover  text-white `} style={{ backgroundImage: 'url("/images/Howoperatebg.svg")', backgroundRepeat: 'no-repeat' }}>
            <div className='flex  pt-10 '>
                <img src='/images/opetate.svg' alt='logo' className='w-[250px] md:w-[300px] lg:w-[430px] xl:w-[453px] h-[209px] md:h-[250px] lg:h-[33 0px] xl:h-[378px]  ' />
                <img src='/images/operate2.svg' alt='logo' className='h-[215px] md:h-[250px] lg:h-[300px] xl:h-[389px] w-[167px] md:w-[200px] lg:w-[250px] xl:w-[302px] mt-[107px] -ml-20 ' />
            </div>
            <div className='flex flex-col gap-y-6 md:gap-y-8 pb-7 lg:mt-[135px] '>
