...
function HowToOperate() {
    return (
        <div className={`h-auto min-h-[510px] lg:gap-20 px-2 md:px-12  xl:px-[90px] w-full flex flex-col lg:flex-row bg-no-repeat bg-cover  text-white `} style={{ backgroundImage: 'url("/images/Howoperatebg.svg")', backgroundRepeat: 'no-repeat' }}>
