...
function Mission() {
  return (
    <div className={`min-h-screen h-auto  px-5 md:px-12 lg:px-[70px] xl:px-[110px] w-full  bg-no-repeat bg-cover bg-center bg-[url('../public/images/aboutusbg.png')] `}>
      <div className='pt-12 md:pt-20 pb-10'>
        <div className={` flex flex-col md:flex-row justify-between gap-20 px-8 md:px-16 items-center h-auto min-h-[414px] rounded-3xl w-full  bg-no-repeat bg-cover bg-center  bg-white bg-[url('../public/images/missiontopbg.png')]`}>
